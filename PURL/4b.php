        ...
        <div id="container">
        	...
        	<section id="content" class="clearfix">
        		...
        		<div id="col-left">
        			...
        			<h2>Oops! We’re very sorry. We didn’t get enough information when you signed up for our Cat&reg; phones updates.</h2>
        			
        			<h3>Please select your country and hit submit.</h3>
        			<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
        				<select class="formatted"><option value="" selected="selected">Please select country</option> 
